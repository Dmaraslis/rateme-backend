...
<div class="col-lg-12" style="margin-bottom: 10px;">
    <div class="row customRowBalanceSubAccount">
        <div class="col-sm-8" style="text-align: left; padding-top: 10px;"><span >Handler Account: <i style="color:#f8ba11">petrediqq@gmail.com</i></span></div>
