...
if($_SESSION['HITCredsUsedForThisTx']['username'] == 'akontos@blocktech.gr'){

}else{
   // $gatherAccountBalance = $hitbtc->gather_sub_account_balance_by_session();
...
<div class="col-lg-12" style="margin-bottom: 10px;">
    <?php if($_SESSION['HITCredsUsedForThisTx']['username'] == 'akontos@blocktech.gr'){?>
        <div class="row customRowBalanceSubAccount">
            <div class="col-sm-8" style="text-align: left"><span >Handler Head Account: <i style="color:#f8ba11"><?=$_SESSION['HITCredsUsedForThisTx']['username']?></i></span></div>
    ...
    <?php }else{ ?>
        <div class="row customRowBalanceSubAccount">
            <div class="col-sm-8" style="text-align: left; padding-top: 10px;"><span >Handler Sub-Account: <i style="color:#f8ba11"><?=$_SESSION['HITCredsUsedForThisTx']['username']?></i></span></div>
