...
<div id="floatingButtonsSection" style="display:none;">
    <div class="row">
        ...
        <div class="col-sm-6">
            ...
            <button  id="customNetworkWithdraw" style="display:none;" class="btn btn-info btn-lg" onclick="withdraw_custom_network()">Custom Network Withdraw</button>
            <button  id="closeSwal" style="display:none;" class="btn btn-info btn-lg" onclick="swal.close();">Swal Close</button>
            <button  id="placeRefund" class="btn btn-info btn-lg" onclick="refund()">REFUND</button>
        </div>
    </div>
</div>
<div class="col-lg-12" style="margin-bottom: 10px;">
    <?php if($walletInfos['apiKeyUsed'] == 'account@instaswap.io'){?>
        <div class="row customRowBalanceSubAccount">
            <div class="col-sm-8" style="text-align: left"><span >Handler Head Account: <i style="color:#f8ba11" id="handlerSubAcc"><?=$walletInfos['apiKeyUsed']?></i></span></div>
    ...
    <?php }else{ ?>
        <div class="row customRowBalanceSubAccount">
            <div class="col-sm-8" style="text-align: left; padding-top: 10px;"><span >Handler Sub-Account: <i style="color:#f8ba11" id="handlerSubAcc"><?=$walletInfos['apiKeyUsed']?></i></span></div>
...
<div class="col-lg-12" style="margin-bottom: 10px;" id="checkNetworksContainer">
    <div class="col-sm-12" style="padding:0px;">
        <div class="row" id="checkNetworks">
        </div>
    </div>
</div>
...
<div class="ibox border-bottom">
    <div class="ibox-title" style="padding:10px;">
        ...
        <div class="ibox-tools">
            <a class="collapse-link" id="depositsHistory">
    ...
    <div class="ibox-content">
        <div class="row" id="depositHistory">
            <div class="sk-spinner sk-spinner-wave">
                <div class="sk-rect1"></div>
                <div class="sk-rect2"></div>
                <div class="sk-rect3"></div>
