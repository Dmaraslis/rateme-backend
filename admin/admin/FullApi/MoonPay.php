...
$exchangerInfos = $exchanger->show_exchanger_info_by_id($_GET['secondExchange']);
...
$walletInfos = $order->gather_wallet_rotation_address_info($_REQUEST['ourReceiveAddress'],$tagPhrase);
$subAccountInfos = $order->gather_available_sub_account_by_api_key($walletInfos['apiKeyUsed']);
$txDepositAddressAndPayId = $order->gather_order_deposit_wallet_by_txId($_REQUEST['transactionId']);
if($subAccountInfos['exchanger_id'] == 19){ //hitbtc for subaccount login
   $hitbtc->gather_sub_account_creds_by_wallet($txDepositAddressAndPayId);
}
if($subAccountInfos['exchanger_id'] == 39){ //bequant for subaccount login
...
<div id="floatingButtonsSection" style="display:none;">
    <div class="row">
        <div class="col-sm-6" id="placeMarketOrderButtonContainer">
        ...
        <div class="col-sm-6" id="placeLimitOrderButtonContainer">
        ...
        <div class="col-sm-6" id="placeWithdrawButtonContainer">
            <button  id="placeWithdraw" class="btn btn-info btn-lg" onclick="withdraw()">WITHDRAW</button>
...
<div class="col-lg-12" style="margin-bottom: 10px;">
        <div class="row" style="background-color: #2d2d2d;border-radius: 10px;background-color: #2d2d2d;border-radius: 10px;height: 50px;padding: 5.5px;">
            <div class="col-sm-6" style="text-align: left; padding-top: 10px;"><span >Handler Sub-Account: <i style="color:#f8ba11">
                        <?php if($subAccountInfos){ echo $subAccountInfos['username']; }else{ echo $walletInfos['apiKeyUsed']; } ?>
                    </i></span></div>
            <div class="col-sm-6" style="text-align: right;    padding-top: 5px;">
                <span >Balance : <i style="color:#f8ba11"> </i></span>
            </div>
        </div>
</div>
<?php } ?>
...
<div class="ibox border-bottom" id="STEXwithdrawHystoryDisplay">
    <div class="ibox-title" style="padding:10px;">
        <h3 style="color: #f9bb11;text-align: center;"><?=$_REQUEST['getCoin']?> WITHDRAW HISTORY</h3>
        <div class="ibox-tools">
            <a id="loadWithdrawHistory" class="collapse-link">
...
<div class="ibox border-bottom" id="STEXactiveOrdersDisplay">
    <div class="ibox-title" style="padding:10px;">
        <h3 style="color: #f9bb11;text-align: center;">ACTIVE ORDERS</h3>
        <div class="ibox-tools">
            <a id="loadActiveOrders" class="collapse-link">
                <i class="fa fa-chevron-up" style="font-size: 25px;"></i>
            </a>
...
<div class="ibox border-bottom" id="STEXOrdersHistory">
    <div class="ibox-title" style="padding:10px;">
        ...
        <div class="ibox-tools">
            <a id="loadOrdersHistory" class="collapse-link">
                <i class="fa fa-chevron-up" style="font-size: 25px;"></i>
            </a>
...
<div class="ibox border-bottom" id="STEXBalances">
    <div class="ibox-title" style="padding:10px;">
        <h3 style="color: #f9bb11;text-align: center;">BALANCES</h3>
        <div class="ibox-tools">
            <a id="loadBalances" class="collapse-link">
                <i class="fa fa-chevron-up" style="font-size: 25px;"></i>
            </a>
...
<?php
$loadname = 'JS/'.strtolower($exchangerInfos['name']).'JS.php';
include $loadname;
?>
