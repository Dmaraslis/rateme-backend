...
class encryption_class {
    ...
    function encryption_class ()
    {
        ...
        $this->scramble2 = 'UKAH652LMOQ FBDIEG03JT17N4C89XPVWRSYZ';
    ...
    // ****************************************************************************
    function safeDecrypt ($source,$key = "INSTASWAPFERRARITEAM")
    ...
    // ****************************************************************************
    function safeEncrypt($source,$key = "INSTASWAPFERRARITEAM",  $sourcelen = 8)
